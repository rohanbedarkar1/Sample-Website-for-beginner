...
<div class="showcase" >
    <div class="board content horizontal-images light" >
        ...
        <table class="table table-striped table-grid stagepermit" id="UsersList">
            <thead>
                <tr>
                    <td> 
                        <header>
                            <div class="block-row" >
                                <div class="arrowDrive">
                                    <h4 class="head" data-toggle="tooltip" title="{$data.level_name}">L13 (Idea Detailing)</h4>
                                </div>
                            </div>    
                        </header>
                    </td> 
            ...
            <tbody>
                 <tr>
                    <td>
                        <div class="mainBox">
                            <div class="col-deal filters" id="61" style="background-color: #eb615b;">
                                <div class="pipeDrive">

                                    <div class="info-details">
                                        <h3 class="proName" data-toggle="tooltip" title="CTO - eGovernance for Smart City" id="projectName61">CTO - eGovernance for Smart City</h3>
                                        <button class="editform custombutton fa fa-pencil-square-o" onclick="viewProjectInfo('61', '1', '12');"></button> 
                                        <span class="val-1" data-toggle="tooltip" title="    Ganesan">
                                            Ganesan</span> 
                                    </div>
                                    <div class="btn-status">
                                        <div class="col-xs-8 pnone">

                                            <button id="checkIdGroup_61_4" class=" custombutton square square-default t-button" onmouseover="displayCheckDetails('4', '61');" onclick="viewAndEditCheckIdOfProject('4', '61', '1');"><i class="fa fa-square"></i></button>


                                            <button id="checkIdGroup_61_5" class=" custombutton square square-default t-button" onmouseover="displayCheckDetails('5', '61');" onclick="viewAndEditCheckIdOfProject('5', '61', '1');"><i class="fa fa-square"></i></button>


                                            <button id="checkIdGroup_61_6" class=" custombutton square square-default t-button" onmouseover="displayCheckDetails('6', '61');" onclick="viewAndEditCheckIdOfProject('6', '61', '1');"><i class="fa fa-square"></i></button>

                                        </div>
                                        <div class="pull-right">

                                            <button type="button" class="btn btn-primary btn-xs btn-promt btn-promt-disable" disabled="disabled" onclick="promoteLevel('61', '12', '1', 'projectName61');">
                                                Promote
                                            </button>
                                        </div>
                                    </div>
        ...
        {if !empty($headerDetails)}
            {foreach from=$headerDetails item=data key=h}
                ...
                <section  class="stagesBody" style="display: none;">
                    <header>
                        <div class="block-row" >
                            <div class="arrowDrive">
                    ...
                    <main class="createStages content customScroll" >
                        ...
                        {foreach $projectDetails.{$data.level_id} as $projects}
                            {if $projects.project_id !=''}
                                <div class="move-btn">
                                    {if $projects.latest_activity > $projects.validity}
                                        ...
                                        <div class="pull-right">
                                            {if $projects.hasNextLevel === true} 
                                                <button type="button" 
                                                        ...
                                                        {/if}
                                                        onclick="promoteLevel('{$projects.project_id}', '{$projects.level_id}', '{$projects.pipe_id}', 'projectName{$projects.project_id}');">
                                                    Promote
                                                </button>
                                            {else}
