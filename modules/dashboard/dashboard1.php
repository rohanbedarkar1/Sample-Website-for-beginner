...
$smarty->assign("mainTable", 'modules/dashboard/mainTable1.tpl');
...
if (isset($_POST['pipeId']) || isset($_POST['filterValue'])) {
    if (empty($projectsArr)) {
        ...
        $smarty->display('modules/dashboard/mainTable1.tpl');
    }
} else {
    $smarty->display('modules/dashboard/dashboard1.tpl');
}
